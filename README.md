...
-----------
  ...
  |Flutter main project|2023.1.9.1~  <br>  1.23|R을 이용한 AI 머신러닝 학습을 통한 중고차 시세예측 프로젝트 [프로젝트 링크](https://github.com/vxornjs11/R-Spring-Flutter/tree/parktekwon)<br> ![Alt text](/path/to/youtube.png)[유튜브링크](https://www.youtube.com/watch?v=fujMvps_eR8&t=166s)|
